...
export default async function Page() {
  ...
  const recentSessions = [
    { id: 1, title: "渋谷ラウンジ", summary: "チルな夜。ブルーベリーがよかった。" },
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-8 md:grid-cols-2">
        ...
        <CardContent>
          {data.mixes.length === 0 ? (
            <p className="text-sm text-muted-foreground">おすすめデータがまだありません。</p>
          ) : (
                ...
                <div key={mix.title} className="rounded-md border p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">スコア {(mix.score * 100).toFixed(0)}%</p>
                    </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>最近のセッションをざっくり振り返りましょう。</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
